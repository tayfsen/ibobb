        ...
        <nav class="fh5co-nav" role="navigation">
            ...
            <div class="top-menu">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-1">
                            <div id="fh5co-logo"><a href="welcome.blade.php">iBob<span>.</span></a></div>
                        </div>
                        <div class="col-xs-11 text-right menu-1">
                            <ul>
                                ...
                                <li class="btn-cta"><a href="#"><span>Erstelle einen Kurs</span></a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row animate-box">
                    <div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
                        <h2>Hier wird eine Überschrift kommen! Comming soon</h2>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-md-pull-8 animate-box">
                            <div class="mt">
                                <h3>Wir möchten CSS lernen können!</h3>
                                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                                <ul class="list-nav">
